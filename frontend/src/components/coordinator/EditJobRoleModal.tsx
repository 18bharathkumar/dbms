                ...
                <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-900/60 backdrop-blur-sm">
                    ...
                    >
                        <div className="flex justify-between items-center mb-6">
                            <h2 className="text-xl font-bold text-slate-900">Edit Job Role</h2>
                        ...
                        <form onSubmit={onSubmit} className="space-y-4">
                            <div>
                                ...
                                <input
                                    ...
                                    value={editJobRole.title}
                                    onChange={(e) => setEditJobRole({ ...editJobRole, title: e.target.value })}
                                    required
                                />
                            </div>
                            <div className="grid grid-cols-2 gap-4">
                                <div>
                                    ...
                                    <input
                                        ...
                                        step="0.1"
                                        className="w-full mt-1 px-3 py-2 border border-slate-200 rounded-lg focus:ring-2 focus:ring-indigo-500/20 focus:border-indigo-500 outline-none"
                                        value={editJobRole.package}
                                        onChange={(e) => setEditJobRole({ ...editJobRole, package: e.target.value })}
                                        required
                                    />
                                </div>
                                <div>
                                    ...
                                    <input
                                        ...
                                        step="0.01"
                                        className="w-full mt-1 px-3 py-2 border border-slate-200 rounded-lg focus:ring-2 focus:ring-indigo-500/20 focus:border-indigo-500 outline-none"
                                        value={editJobRole.cgpaCutoff}
                                        onChange={(e) => setEditJobRole({ ...editJobRole, cgpaCutoff: parseFloat(e.target.value) })}
                                        required
                                    />
                                </div>
                            </div>
                            <div>
                                ...
                                <textarea
                                    ...
                                    rows={3}
                                    value={editJobRole.packageDetails}
                                    onChange={(e) => setEditJobRole({ ...editJobRole, packageDetails: e.target.value })}
                                    required
                                />
                            </div>
                            <div>
                                ...
                                <select
                                    className="w-full mt-1 px-3 py-2 border border-slate-200 rounded-lg focus:ring-2 focus:ring-indigo-500/20 focus:border-indigo-500 outline-none"
                                    value={editJobRole.slab}
                                    onChange={(e) => setEditJobRole({ ...editJobRole, slab: e.target.value })}
                                >
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    step="any"
                                    className="w-full mt-1 px-3 py-2 border border-slate-200 rounded-lg focus:ring-2 focus:ring-indigo-500/20 focus:border-indigo-500 outline-none"
                                    value={editJobRole.applicationDeadline}
                                    onChange={(e) => setEditJobRole({ ...editJobRole, applicationDeadline: e.target.value })}
                                    required
                                />
                            </div>
